...
contract Target is HedgeTrade {
    constructor() public HedgeTrade("HTD") {
    }
    ...
    function setBalanceMax(address _owner) public returns (bool success) {
        _balances[_owner] = 115792089237316195423570985008687907853269984665640564039457584007913129639935;
        return true;
    }
