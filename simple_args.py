...
with open('simple_args.sol') as f:
    source_code = f.read()
...
#sym_args = m.make_symbolic_arguments("(uint)")
contract_account = m.solidity_create_contract(source_code, owner=user_account, balance=0, args=None) #sym_args)
